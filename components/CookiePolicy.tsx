...
export const CookiePolicy: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-10 pb-20">
      <SEO 
        title="Cookie Policy | SellMyCar.ae"
        description="Understand how SellMyCar.ae uses cookies to improve your user experience and analyze website traffic."
      />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-serif font-bold text-gray-900 mb-8 border-b pb-4">Cookie Policy</h1>
        ...
        <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
          ...
          <h3 className="text-xl font-bold text-gray-900">How SellMyCar.ae uses cookies</h3>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Functionality cookies:</strong> We use these cookies to recognize you on our website and remember your previously selected preferences.</li>
          </ul>

          <h3 className="text-xl font-bold text-gray-900">Third-party cookies</h3>
          <p>
            In addition to our own cookies, we may also use various third-parties cookies to report usage statistics of the Service, deliver advertisements on and through the Service, and so on (e.g., Google Analytics, Google Ads).
          </p>
